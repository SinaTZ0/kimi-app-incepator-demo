...
const mentors = [
  {
    ...
    role: "رهبر پژوهش هوش مصنوعی",
    expertise: "یادگیری ماشین",
    image: "/mentor_portrait.jpg",
    rating: 4.9,
    reviews: 28,
  },
  {
    name: "پروفسور محمد تهرانی",
    role: "مشاور کارآفرینی",
    expertise: "کارآفرینی",
...
const mentorTypes = [
  { icon: Award, label: "سازندگان", desc: "خالقان عملی که به شما کمک می‌کنند محصول عرضه کنید" },
  { icon: BookOpen, label: "بازبینان", desc: "بازخورد انتقادی روی کار شما" },
  { icon: Network, label: "اتصال‌دهندگان", desc: "دسترسی به شبکه و معرفی‌ها" },
];
...
export default function FacultyMentorsSection() {
  ...
  return (
    <section ref={sectionRef} id="faculty" className="relative py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-text-secondary max-w-2xl mx-auto">
            منتورهای ما سازندگان، بازبینان و اتصال‌دهندگان هستند—اینجا برای تسریع کار شما.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          {mentorTypes.map((type, i) => (
            <div key={i} className="glass-card px-6 py-4 flex items-center gap-3 hover:bg-surface/10 transition-colors">
        ...
        >
          {mentors.map((mentor, i) => (
            <div key={i} className="mentor-card glass-card overflow-hidden flex-shrink-0 md:w-80 opacity-0 group">
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-lg font-display font-semibold text-text-primary mb-1">{mentor.name}</h3>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-text-secondary">{mentor.reviews} نظر</span>
