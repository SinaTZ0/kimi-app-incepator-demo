        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-text-secondary leading-relaxed mb-8">
              A 6-month sprint that turned a sensing prototype into a pilot with city planners. 
              This is how we bridge the gap between research and practical application.
            </p>
